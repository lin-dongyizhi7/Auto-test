...
class OpRecord:
    ...
    @classmethod
    def validate_result(cls, element_path: str, attr: str, expect_value: Any, role_name_list: Optional[List[str]] = None, description: str = "") -> None:
        """
        添加断言步骤，转换为 JSON:
        ...
        """
        if not description:
            description = f"校验元素 {element_path} 的 {attr} 值为: {expect_value}"
